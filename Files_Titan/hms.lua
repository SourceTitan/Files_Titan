...
local function keko_Titan(data)
    ...
    dl_cb, nil)
    database:set("Titan:get:hms:msg:"..bot_id..msg.chat_id_..msg.id_..t2.id_,keko_ts[1])
    function bot_id_get(t11,t22)
    bot_username = (t22.username_ or "Titanbot")
    ...
    resolve_username(keko_ts[2],cb_Titan)
    end
    end
    ...
    kekol = database:get("Titan:get:hms:msg:"..bot_id..keko_ts[1]..keko_ts[2])
    if kekol then 
    ...
    database:set("Titan:get:hms:gr:"..bot_id..msg.chat_id_,"Titan")
    send(msg.chat_id_, msg.id_, 1, "🔘┇ تم تعطيل اهمس", 1, 'html')
    end 
    if text and text == "تفعيل اهمس" then 
    database:del("Titan:get:hms:gr:"..bot_id..msg.chat_id_)
