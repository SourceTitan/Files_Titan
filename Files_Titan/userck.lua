...
if result.id_ then 
local keko2 = database:get('Titan:'..bot_id.."keko:Userr"..result.id_)
if not result.username_ then 
if keko2 then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه : @"..keko2, 1, 'html')
database:del('Titan:'..bot_id.."keko:Userr"..result.id_) 
end
end
...
database:set('Titan:'..bot_id.."keko:Userr"..result.id_, result.username_) 
end
end
end
